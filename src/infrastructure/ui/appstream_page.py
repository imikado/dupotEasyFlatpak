...
class AppstreamPage(Adw.NavigationPage):
    ...
    def _build(self, app: AppstreamLongEntity) -> Gtk.Widget:
        ...
        for repo_id_loop in repo_id_list:
            ...
            source_icon = IconsShared().get_icon_by_name(IconsShared.ICON_NETWORK)
        ...
        if app.has_url_homepage():
            ...
            row.add_prefix(icon)
            arrow = IconsShared().get_icon_by_name(IconsShared.ICON_CHEVRON_RIGHT)
    ...
    def _on_screenshot_clicked(self, _btn, urls: list, index: int):
        ...
        prev_btn = Gtk.Button()
        prev_btn.set_child(IconsShared().get_icon_by_name(IconsShared.ICON_CHEVRON_LEFT))
        ...
        next_btn = Gtk.Button()
        next_btn.set_child(IconsShared().get_icon_by_name(IconsShared.ICON_CHEVRON_RIGHT))
