...
def _make_app_card(app, on_click, square: bool = False, *on_click_args) -> Gtk.Button:
    button = Gtk.Button()
...
class AppListGridShared:
    ...
    def __init__(self, square: bool = False):
        ...
        self._flow_box.set_max_children_per_line(8 if square else 6)
        self._flow_box.set_min_children_per_line(3 if square else 2)
    ...
    def append(self, app, on_click, *on_click_args):
        self._flow_box.append(_make_app_card(app, on_click, self._square, *on_click_args))
